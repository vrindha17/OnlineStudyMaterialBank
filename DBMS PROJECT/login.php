...
<?php 
  include('header.php');
        echo "<script>$('#navbar-heading').css('display', 'none');</script>";  
                echo "<script>$('#navbar-headingtext').css('display', 'block');</script>";  
...
<?php 
  if(isset($_POST['username'])&&isset($_POST['password'])){
      ...
      $sqlQuery = "Select * from user where UserId='".$username."' and Password='".$password."'";

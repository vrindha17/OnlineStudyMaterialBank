...
<h2>UPLOAD STUDY MATERIALS </h2></font>


<form class="form-horizontal" method="post" action="uploadaction.php" name="upload" enctype = "multipart/form-data">
<div class="form-group">
<label class="control-label col-sm-2" for="department">Department :</label>
<div class="col-sm-10">
 <select id="department" name="department"  onchange="populate(this.id,'course')">
   <option disabled selected value style="text-align:center;">--select--</option>
...
<div class="col-sm-10">
 <select name="resource_type" id="resource_type" required>
  <option name="question_paper" value="question_paper">Question Paper</option>
   <option name="material" value="material">Text Book</option>
  </select> </div>
</div>
...
<div class="col-sm-10">
    <select id="selectElementId" name="year" onfocus="list_year()">
        <option disabled selected value >--select--</option>
    </select>
  </div>
</div>
...
<div class="form-group" id="textbook" style="display:none;">
<label class="control-label col-sm-2" for="text_name">Text Book Name :</label>
<div class="col-sm-10">
